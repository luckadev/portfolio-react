...
const Skills = () => {
  return (
    <div className='container'>
      <Title h1children={"Skills"} pchildren={"Quais tecnologias eu tenho experiência e uso hoje em dia."} />
      ...
      <div className='tech-container'>
        <div className='tech-col'>
          ...
          <a target='blank' href="https://nodejs.org" title='Node.js'><img src="./assets/icon-node.png" alt="Node.js" width='48' /><span>Node.js</span></a>
          ...
          <a target='blank' href="https://www.mysql.com" title='MySql'><img src="./assets/icon-mysql.png" alt="mysql" /><span>mysql</span></a>
          <a target='blank' href="https://firebase.google.com/?hl=pt-br" title='Firebase'><img src="./assets/icon-firebase.png" alt="Firebase" /><span>Firebase</span></a>

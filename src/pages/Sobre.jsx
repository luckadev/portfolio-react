  ...
  return (
    <div className='container container-sobre'>
      <div className='text-left'>
        ...
        <p>
          e sou programador, ou como a maioria gosta de chamar, Desenvolvedor Frontend, tenho 18 anos, nasci em Piracicaba que fica localizado no interior de São Paulo.
        </p>
        <p>
      ...
      <div className='photo-right'>
        ...
        <ul>
          <li><a href="https://github.com/devlucaspro"><i className="fa-brands fa-github"></i> Veja meus projetos no Github.</a></li>
